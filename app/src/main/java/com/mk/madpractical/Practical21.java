...
public class Practical21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.Practical21layout), (v, insets) -> {
    ...
    private void fetchStudentData() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(Practical21.this, "Error fetching the data", Toast.LENGTH_SHORT).show();
            }
