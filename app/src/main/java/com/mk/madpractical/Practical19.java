...
public class Practical19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.Practical19_layout), (v, insets) -> {
        ...
        rollno = findViewById(R.id.Pr19RollNo);
        name = findViewById(R.id.Pr19Name);
        sem = findViewById(R.id.Pr19Semester);
        action = findViewById(R.id.Pr19action_btn);
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    URL url = new URL("http://192.168.66.127:5700/MAD-Pr19.php");
